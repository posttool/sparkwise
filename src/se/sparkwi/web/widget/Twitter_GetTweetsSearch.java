...
public class Twitter_GetTweetsSearch extends WidgetDefinition
{
	...
	{
		// we don't count replies as mentions. right now retweets are being
		// counted as mentions though.
		String username = (String) selector_values.get("username");
		Feed f = TwitterUtil.search("from:" + username.substring(1));
