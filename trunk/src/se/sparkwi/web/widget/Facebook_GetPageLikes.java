...
public class Facebook_GetPageLikes extends WidgetDefinition
{
	...
	{
		OBJECT response = api.call("/" + selector_values.get("fan page"));
		return new OBJECT("value", response.I("likes"));
	}
