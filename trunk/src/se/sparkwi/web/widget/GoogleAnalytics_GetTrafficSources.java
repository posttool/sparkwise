...
public class GoogleAnalytics_GetTrafficSources extends WidgetDefinition
{
	@Override
	...
	{
		return GoogleAnalyticsUtil.DICT_RETURN_TYPES;
	}
	...
	protected OBJECT get_data(ConnectionApi api, OBJECT selector_values, OBJECT props) throws WebApplicationException
	{
		...
		return GoogleAnalyticsUtil.getDictData(api, account, page, "ga:medium", "ga:visitors");
	}
