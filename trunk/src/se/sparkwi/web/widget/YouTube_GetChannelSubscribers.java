...
public class YouTube_GetChannelSubscribers extends WidgetDefinition
{
	...
	protected OBJECT get_data(ConnectionApi api, OBJECT selector_values, OBJECT props) throws WebApplicationException
	{
		...
		OBJECT response = api.call("/users/"+api.profile().get("username"));
		return new OBJECT("value",response.I("entry.yt$statistics.subscriberCount"));
	}
