...
public class Twitter_GetLinkSearch extends WidgetDefinition
{
	...
	{
		return new OBJECT[] { new OBJECT(SERVICE_SELECTOR_NAME, "link", SERVICE_SELECTOR_TYPE, SELECTOR_TYPE_FREE_TEXT) };
	}
	...
	{
		Feed f = TwitterUtil.search(selector_values.S("link"));
