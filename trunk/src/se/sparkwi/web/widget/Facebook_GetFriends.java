...
public class Facebook_GetFriends extends WidgetDefinition
{
	...
	{
		OBJECT response = api.call("/me/friends");
		ARRAY friends_list = response.A("data");
		return new OBJECT("value", friends_list.size());
	}
