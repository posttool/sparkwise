...
public interface AuthorizationBaseHandler
{
	public void process(UserApplicationContext uctx, OAuthorizationModule module, HttpServletRequest request, HttpServletResponse response) throws PersistenceException,IOException,WebApplicationException;
